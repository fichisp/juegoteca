...
public class ListadoJuegosFechaArrayAdapter extends ArrayAdapter<Juego> {
     ...
     * @param juegos
     */
    public ListadoJuegosFechaArrayAdapter(Activity context, Juego[] juegos) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        View item = inflater.inflate(R.layout.listado_juego_sin_caratula_fecha, null);
        ...
        TextView fecha = (TextView) item.findViewById(R.id.fecha_lanzmiento);
        fecha.setText(juegos[position].getFechaLanzamiento());
