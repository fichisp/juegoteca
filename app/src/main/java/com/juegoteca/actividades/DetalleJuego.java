...
public class DetalleJuego extends Activity {
	...
	protected void loadData() {
		...
		esNuevoJuego = intent.getExtras().getBoolean("NUEVO_JUEGO");
	...
	private void cargarFichaJuego(Juego juego) {
		...
		if (!esJuegoOnline) {
			...
			if (juego.getCompletado() == 1) {
				...
				// checkCompletado.setButtonDrawable(this.getResources()
				// .getDrawable(R.drawable.check_off_32));
		...
		} else {// Estos campos no se cargan cuando es una ficha de un juego
				// online
	 ...
	 * 
	 * @param idGenero
	 *            Identificador del género en la base de datos
	 */
	 ...
	 * 
	 * @param idIdioma
	 *            Identificador del idioma en ela base de datos
	 */
	 ...
	 *            Identificador de la clasificación en la base de datos
	 */
	 ...
	 * 
	 * @param idPlataforma
	 *            Identificador de la plataforma en la base de datos
	 */
